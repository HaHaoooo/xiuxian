...
public class MidLingShiOre1 extends Block {
    public static Block INSTANCE = new MidLingShiOre1();
    public MidLingShiOre1() {
        super(Material.ROCK, MapColor.STONE);
        this.setSoundType(SoundType.GLASS);
        this.setHardness(3.5F);
        this.setHarvestLevel("pickaxe", 2);
        this.setCreativeTab(XiuXian_CreativeTabs.XIUXIAN_BLOCK);
        this.setRegistryName("xiuxian:mid_ling_shi_ore_1");
        this.setUnlocalizedName("xiuxian.mid_ling_shi_ore_1");
    ...
    public boolean canPlaceBlockOnSide(@Nonnull World worldIn, @Nonnull BlockPos pos, @Nonnull EnumFacing side) {
        return worldIn.getBlockState(pos.down(1)).getBlock() == MidLingShiMainBlock.INSTANCE;
    }
    @Override
