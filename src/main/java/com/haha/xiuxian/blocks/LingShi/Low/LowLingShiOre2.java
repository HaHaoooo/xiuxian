...
public class LowLingShiOre2 extends Block {

    public static Block INSTANCE = new LowLingShiOre2();

    public LowLingShiOre2() {
        super(Material.ROCK, MapColor.STONE);
        this.setSoundType(SoundType.GLASS);
        this.setHardness(3.5F);
        this.setHarvestLevel("pickaxe", 2);
        this.setCreativeTab(XiuXian_CreativeTabs.XIUXIAN_BLOCK);
        this.setRegistryName("xiuxian:low_ling_shi_ore_2");
        this.setUnlocalizedName("xiuxian.low_ling_shi_ore_2");
    ...
    public int quantityDropped(@Nonnull Random random) {
        Random randomCnt = new Random();
        return randomCnt.nextInt(2) + 2;
    }
    ...
    public boolean addDestroyEffects(@Nonnull World world, @Nonnull BlockPos pos, @Nonnull ParticleManager manager) {
        ...
        for (int i = 0; i < 100; i++) {
            world.spawnParticle(EnumParticleTypes.END_ROD, x, y, z, 0, 0.2, 0, 1);
        }
        return true;
    }
