...
public class WoodGongFaBase extends Item {
    public static WoodGongFaBase INSTANCE = new WoodGongFaBase();

    public WoodGongFaBase(){
        this.setRegistryName("xiuxian:wood_gongfa");
        this.setUnlocalizedName("xiuxian.wood_gongfa");
