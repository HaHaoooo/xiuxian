...
public class ExtremeLingShi extends Item {
    public static final ExtremeLingShi INSTANCE = new ExtremeLingShi();

    public static String[] attrs = {"§6金", "§3木", "§1水", "§c火", "§e土"};
    public ExtremeLingShi(){
        setUnlocalizedName("xiuxian.extreme_ling_shi");
        setRegistryName("xiuxian:extreme_ling_shi");
    ...
    public ActionResult<ItemStack> onItemRightClick(@Nonnull World worldIn, @Nonnull EntityPlayer playerIn, @Nonnull EnumHand handIn) {
        ...
        if (nbt == null) {
            ...
            int lingqi = new Random().nextInt(200) + 200;
            ...
            newItem.setStackDisplayName(this.getItemStackDisplayName(heldItem) + "【" + name + "§e】");
