...
public class MidLingShi extends Item {
    public static final MidLingShi INSTANCE = new MidLingShi();
    ...
    public ActionResult<ItemStack> onItemRightClick(@Nonnull World worldIn, @Nonnull EntityPlayer playerIn, @Nonnull EnumHand handIn) {
        ...
        if (nbt == null) {
            ...
            int lingqi = new Random().nextInt(50) + 50;
            ...
            newItem.setStackDisplayName(this.getItemStackDisplayName(heldItem) + "【" + name + "§b】");
