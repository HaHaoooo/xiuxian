package com.haha.xiuxian.items.fabao.empty;
...
public class EmptyFu1 extends Item {
    public static EmptyFu1 INSTANCE = new EmptyFu1();

    public EmptyFu1(){
        this.setRegistryName("xiuxian:empty_fu_1");
        this.setUnlocalizedName("xiuxian.empty_fu_1");
